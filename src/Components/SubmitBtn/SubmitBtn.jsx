    ...
    <button
      className={`w-[120px] h-[40px] p-3 flex justify-center items-center rounded-md relative transition-all active:scale-100 active:shadow-[0px_0px_0px_0px_var(--text-200)] ${
        !btnIsActive
          ...
          : "bg-gradient-to-r from-[var(--accent-100)] to-[var(--accent-200)] border-solid border-[var(--primary-300)] border-[1px] text-[var(--text-100)] scale-105 shadow-[0px_0px_4px_2px_var(--text-200)]"
      }`}
